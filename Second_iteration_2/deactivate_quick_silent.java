...
public class deactivate_quick_silent extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(quick_sharedpreferences.getInt("quick_cancelled",0)==0)
        {
        ...
        {
            quick_editor.putInt("quick_cancelled",0);
            quick_editor.commit();
        }
    ...
    public void displayNotification1()
    {
        ...
        editor.putInt("id",quick_sharedpreferences.getInt("quick_id", 0));
        editor.commit();
        //i.putExtra("id",quick_sharedpreferences.getInt("quick_id", 0));
